    ...
    function displayParticipants() {
        ...
        participantsContainer.innerHTML = participants.map(p => `
            <div class="col-4 col-md-4 col-lg-2">
                <div class="card mb-3">
                    <img src="/images/student_${parseInt(p.id)}.jpeg" alt="${p.name}" class="card-img-top" style="height: 100px; object-fit: cover;">
                    <div class="card-body">
            ...
            groupDiv.innerHTML = `<h3 style="color: ${color};">${emoji} Gruppe ${name}</h3><ul class="list-group">` +
                group.map(p => `
                    <li class="list-group-item d-flex align-items-center">
                        <img src="/images/student_${parseInt(p.id)}.jpeg" alt="${p.name}" class="me-3" style="max-width: 99px; height: auto;">
                        <div>
                            <div>${p.name}</div>
